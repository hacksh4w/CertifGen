...
# Output Paths
output_path = '/Users/mrina/Desktop/Certifs'
...
for i in range(1,4):
	...
	# TO show certif in new window 
	#cv.imshow(certi_path, img)   https://www.askpython.com/python-modules/opencv-puttext try this urself
